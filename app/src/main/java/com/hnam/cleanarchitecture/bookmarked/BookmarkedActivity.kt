package com.hnam.cleanarchitecture.bookmarked
...
import com.hnam.presentation.BrowseBookmarkedProjectsViewModel
...
class BookmarkedActivity : AppCompatActivity(){
    ...
    private fun setupBrowseRecycler() {
        recycler_projects.layoutManager = LinearLayoutManager(this) as RecyclerView.LayoutManager?
